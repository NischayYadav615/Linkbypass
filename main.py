...
# bot
bot_token = os.environ.get("TOKEN", "6088122185:AAHmr2q2JCIdEu3pfCDykLb8SBv0q25CSII")
api_hash = os.environ.get("HASH", "c0d3395590fecba19985f95d6300785e") 
api_id = os.environ.get("ID", "24720215")
